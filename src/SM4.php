...
namespace Ritaswc\SM;

use Ritaswc\SM\Exception\PHPVersionOutOfDateException;
use Ritaswc\SM\Exception\UnsupportedOSVersionException;
...
class SM4
{
    ...
    {
        if (PHP_INT_SIZE < 8) {
            throw new UnsupportedOSVersionException('64bit OS supported only');
        }
        if (version_compare(PHP_VERSION, "7.0", "<")) {
            throw new PHPVersionOutOfDateException('php version 7.0 or greater');
        }
    }
